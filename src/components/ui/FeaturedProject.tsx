    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="rounded-xl lg:backdrop-blur-xl lg:border lg:border-violet-400/20 lg:bg-white/80 dark:lg:bg-[#0e0d26]/80 lg:shadow-xl lg:shadow-violet-500/10 lg:p-5">
            <div
              className={cn(
      ...
      >
        ...
        <div className={cn('backdrop-blur-xl border-t border-violet-400/15 bg-white/85 dark:bg-[#0e0d26]/85 p-5 space-y-2')}>
          <div>
